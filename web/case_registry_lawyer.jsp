<%-- 
    Document   : case_registry_lawyer
    Created on : 08-Jun-2017, 02:18:51
...
<div id="sidebar"><a href="#" class="visible-phone"><i class="icon icon-home"></i> Dashboard</a>
  <ul>
    ...
    <li class="active"><a href="case_registry_lawyer.jsp"><i class="icon icon-folder-open"></i> <span>Case Registry</span></a></li>
            ...
            <table class="table table-bordered table-striped">
              ...
              <tbody>
                ...
                <tr class="odd gradeX">
                  ...
                  <td><div class="fr"> 
                          <a onclick="window.document.location='print_case_progress_lawyer.jsp?case_id='+'<%=rs.getString("case_id")%>';" href="#" class="btn btn-success btn-mini">Print Case</a> 
                      </div>
                  </td>
                </tr>
                <%
